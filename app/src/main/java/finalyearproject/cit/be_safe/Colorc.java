 ...
 */
public class Colorc extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        white.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (white.getCurrentTextColor() == Color.RED) {
                    Intent nes = new Intent("finalyearproject.cit.be_safe.GCOLORC");
                    startActivity(nes);
                    ...
                    if (cursor != null && (cursor.getCount() > 0)) {
                        ...
                        do {
                            ...
                            gps=new GpsTracker(Colorc.this);
        ...
        red.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(red.getCurrentTextColor()== Color.RED){
                    Intent nes=new Intent("finalyearproject.cit.be_safe.GCOLORC");
                    startActivity(nes);
                }
                else
        ...
        blue.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (blue.getCurrentTextColor() == Color.RED) {
                    Intent nes = new Intent("finalyearproject.cit.be_safe.GCOLORC");
                    startActivity(nes);
                } else {
                    Toast.makeText(getApplication(), "Sorry you're not at all fit for driving", Toast.LENGTH_LONG).show();
        ...
        green.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (green.getCurrentTextColor() == Color.RED) {
                    Intent nes = new Intent("finalyearproject.cit.be_safe.GCOLORC");
                    startActivity(nes);
                } else {
                    Toast.makeText(getApplication(), "Sorry you're not at all fit for driving", Toast.LENGTH_LONG).show();
        ...
        yellow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (yellow.getCurrentTextColor() == Color.RED) {
                    Intent nes = new Intent("finalyearproject.cit.be_safe.GCOLORC");
                    startActivity(nes);
                } else {
                    Toast.makeText(getApplication(), "Sorry you're not at all fit for driving", Toast.LENGTH_LONG).show();
        ...
        black.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (black.getCurrentTextColor() == Color.RED) {
                    Intent nes = new Intent("finalyearproject.cit.be_safe.GCOLORC");
                    startActivity(nes);
                } else {
                    Toast.makeText(getApplication(), "Sorry you're not at all fit for driving", Toast.LENGTH_LONG).show();
        ...
        indigo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (indigo.getCurrentTextColor() == Color.RED) {
                    Intent nes = new Intent("finalyearproject.cit.be_safe.GCOLORC");
                    startActivity(nes);
        ...
        orange.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (orange.getCurrentTextColor() == Color.RED) {
                    Intent nes = new Intent("finalyearproject.cit.be_safe.GCOLORC");
                    startActivity(nes);
        ...
        violet.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (violet.getCurrentTextColor() == Color.RED) {
                    Intent nes = new Intent("finalyearproject.cit.be_safe.GCOLORC");
                    startActivity(nes);
