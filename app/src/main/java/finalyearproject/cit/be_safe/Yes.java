 ...
 */
public class Yes extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        msg2=(Button)findViewById(R.id.smsyes);
            ...
            public void onClick(View v) {
                ...
                if (cursor != null && (cursor.getCount() > 0)) {
                    ...
                    do {
                        ...
                        gps=new GpsTracker(Yes.this);
                        if(gps.canGetLocation()){
                            double latitude=gps.getLatitude();
                            double longitude=gps.getLongitude();
                            String locations="User Location \n"+"Latitude="+latitude+"\n"+"Longitude="+longitude+"\n"+"www.maps.google.com/?ie=UTF8&hq=&ll="
                                    +latitude+","+longitude;
                            smsManager.sendTextMessage(phone, null, name +locations+ " fit to drive - Be-Safe", null, null);
