 ...
 */
public class Ycolorc extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.colory);
        ...
        indigo.setTextColor(randomAndroidColor6);
        orange.setTextColor(randomAndroidColor7);
        violet.setTextColor(Color.YELLOW);
        white.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (white.getCurrentTextColor() == Color.YELLOW) {
                    Intent nes = new Intent("finalyearproject.cit.be_safe.MATHSQ");
                    startActivity(nes);
                    ...
                    if (cursor != null && (cursor.getCount() > 0)) {
                        ...
                        do {
                            ...
                            gps=new GpsTracker(Ycolorc.this);
        ...
        red.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(red.getCurrentTextColor()== Color.YELLOW){
                    Intent nes=new Intent("finalyearproject.cit.be_safe.MATHSQ");
                    startActivity(nes);
                }
                else
        ...
        blue.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (blue.getCurrentTextColor() == Color.YELLOW) {
                    Intent nes = new Intent("finalyearproject.cit.be_safe.MATHSQ");
                    startActivity(nes);
                } else {
                    Toast.makeText(getApplication(), "Sorry you're not at all fit for driving", Toast.LENGTH_LONG).show();
        ...
        green.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (green.getCurrentTextColor() == Color.YELLOW) {
                    Intent nes = new Intent("finalyearproject.cit.be_safe.MATHSQ");
                    startActivity(nes);
                } else {
                    Toast.makeText(getApplication(), "Sorry you're not at all fit for driving", Toast.LENGTH_LONG).show();
        ...
        yellow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (yellow.getCurrentTextColor() == Color.YELLOW) {
                    Intent nes = new Intent("finalyearproject.cit.be_safe.MATHSQ");
                    startActivity(nes);
                } else {
                    Toast.makeText(getApplication(), "Sorry you're not at all fit for driving", Toast.LENGTH_LONG).show();
        ...
        black.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (black.getCurrentTextColor() == Color.YELLOW) {
                    Intent nes = new Intent("finalyearproject.cit.be_safe.MATHSQ");
                    startActivity(nes);
                } else {
                    Toast.makeText(getApplication(), "Sorry you're not at all fit for driving", Toast.LENGTH_LONG).show();
        ...
        indigo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (indigo.getCurrentTextColor() == Color.YELLOW) {
                    Intent nes = new Intent("finalyearproject.cit.be_safe.MATHSQ");
                    startActivity(nes);
        ...
        orange.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (orange.getCurrentTextColor() == Color.YELLOW) {
                    Intent nes = new Intent("finalyearproject.cit.be_safe.MATHSQ");
                    startActivity(nes);
        ...
        violet.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (violet.getCurrentTextColor() == Color.YELLOW) {
                    Intent nes = new Intent("finalyearproject.cit.be_safe.MATHSQ");
                    startActivity(nes);
